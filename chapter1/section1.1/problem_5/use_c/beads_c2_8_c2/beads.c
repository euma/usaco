...
int main() {
  ...
  //char beads[400];
  //char beads[400]="rrr"; //ok! 3
  //char beads[400]="wwwbbwrrwww"; //ok! 11
  //char beads[400]="wwwwwww"; //ok! 7
  //char beads[400]="wwwbbrwbrrwww"; //ok! 10
  //char beads[400]="wwwwwwwb"; //ok! 8
  //char beads[400]="wwwwwwwbbbbbbb"; //ok! 14
  //char beads[400]="wwwwwwwrrbbbbbbb"; //ok! 16
  char beads[400]="rwwwwwww";
